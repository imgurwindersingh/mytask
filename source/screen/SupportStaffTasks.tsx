...
const SupportedStaffTasks = (props:any) => {
  ...
  const fetchTaskAPI = () => {
    ...
    const requestBody = {};
    singleton
      .createRequest(requestBody, Constants.supportStaffTasksAPI, Method.GET)
  ...
  return (
    <View style={{ flex: moderateScale(1) }}>
      <StatusBar
        ...
        translucent={false}
      />
      <MyTaskHeader props={props} currentScreen={CurrentScreen.SUPPORT_STAFF_TASKS} /> 
      {
...
export default SupportedStaffTasks;