...
const TaskDueIn3Days = (props:any) => {
  ...
  const fetchTaskAPI = () => {
    ...
    const requestBody = {};
    singleton
      .createRequest(requestBody, Constants.taskDuein3DaysAPI, Method.GET)
  ...
  return (
    <View style={{ flex: moderateScale(1) }}>
      <StatusBar
        ...
        translucent={false}
      />
      <MyTaskHeader props={props} currentScreen={CurrentScreen.TASK_DUE_IN_3_DAYS} /> 
      {
