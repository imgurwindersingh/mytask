...
const MyAssignedTasks = (props:any) => {
  ...
  const fetchTaskAPI = () => {
    ...
    const requestBody = {};
    singleton
      .createRequest(requestBody, Constants.assignedTasksAPI, Method.GET)
  ...
  return (
    <View style={{ flex: moderateScale(1) }}>
      <StatusBar
        ...
        translucent={false}
      />
      <MyTaskHeader props={props} currentScreen={CurrentScreen.MY_ASSIGNED_TASKS} /> 
      {
